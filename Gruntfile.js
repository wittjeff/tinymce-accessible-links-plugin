...
module.exports = (grunt) => {
  ...
  grunt.initConfig({
    ...
    concat: {
      license: {
        ...
        files: {
          'dist/tinymce-accessible-links-plugin/plugin.js': [
            'src/text/license-header.js',
            scratchPluginMinPath
          ],
          'dist/tinymce-accessible-links-plugin/plugin.min.js': [
            'src/text/license-header.js',
            scratchPluginMinPath
          ]
        }
    ...
    copy: {
      css: {
        files: [
          { src: [ 'CHANGELOG.txt', 'LICENSE.txt' ], dest: 'dist/tinymce-accessible-links-plugin', expand: true }
        ]
      }
    },
  ...
  grunt.registerTask('version', 'Creates a version file', () => {
    grunt.file.write('dist/tinymce-accessible-links-plugin/version.txt', BUILD_VERSION);
  });
